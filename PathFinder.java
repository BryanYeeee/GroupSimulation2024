...
public class PathFinder  
{
    ...
    public PathFinder(MyWorld w)
    {
        String[] nodeConfig = new String[] {
            ...
            "107 105 172","143 188 172","108 287 172",
            "5 104 233","6 165 233","7 196 233","8 226 233","9 287 233",
            "20 104 263 0 0 0 0","21 165 263 0 0 0 0",          "22 226 263 0 0 0 0","23 287 263 0 0 0 0",
            "24 104 294 0 0 0 0","25 165 294 0 0 0 0",          "26 226 294 0 0 0 0","27 287 294 0 0 0 0",
            "10 104 324","11 165 324","12 196 324","13 226 324","14 287 324",
            "28 104 355 0 0 0 0","29 165 355 0 0 0 0",          "30 226 355 0 0 0 0","31 287 355 0 0 0 0",
            "32 104 385 0 0 0 0","33 165 385 0 0 0 0",          "34 226 385 0 0 0 0","35 287 385 0 0 0 0",
            ...
            // Janitor
            "140 882 294","141 882 384","142 803 384",
            // MC Cells (connected to node 36 38):
            "132 438 569","133 469 569","134 500 569","135 559 569","136 591 569","137 621 569",
            // Escape
            "138 560 0",
            "139 286 474 0 0 0 6","145 154 474 0 0 0 6","146 154 513 0 0 0 0","147 0 513 0 0 0 0",
            "144 188 0",
        ...
        String[] nodeConnections = new String[] {
            ...
            // Dining Hall (connected to node 2):
            "107 143","143 108","108 9",
            "5 6","6 7",        "7 8","8 9",
            "5 20","6 21","7 12","8 22","9 23",
            "10 24","11 25",    "13 26","14 27",
            "10 149","149 11","11 12","12 13","13 14","14 2",
